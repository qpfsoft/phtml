...
class Webkit extends CssAttr
{
     ...
     * 文字描边
     *
     * @param string $width 描边厚度, 例`1px`
     * @param string $color 描边颜色, 例`#f00`
     * @return string
     */
     ...
     * 文字的描边厚度
     *
     * @param string $value 描边厚度, 例`1px`,不允许负值
     * @return string
     */
