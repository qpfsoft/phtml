...
class Css3 extends CssAttr
{
     ...
     * @param string $font_url 字体.eot位置
     * @return string
     */
     ...
     *
     * @param string $value - normal：正常文字宽度
    ...
    public function columns($width, $count)
    {
        ...
        return $this->cssPrefix('columns' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-width' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-count' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-gap' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    public function column_rule($width, $style, $color)
    {
        ...
        return $this->cssPrefix('column-rule' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-rule-width' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-rule-style' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-rule-color' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-span' . self::space() . $value . self::end, [
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-fill' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-break-before' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-break-after' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
    ...
    {
        return $this->cssPrefix('column-break-inside' . self::space() . $value . self::end, [
            '-moz-',
            '-webkit-'
        ]);
    }
