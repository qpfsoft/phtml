...
class Border extends CssAttr
{
     ...
     * 设置边框 - 四边相同
     *
     * @param string $width 边框的宽度, 边框宽度可能的值:
     * - thin : 定义细的边框
     * - medium : 默认。定义中等的边框
     * - thick : 定义粗的边框
     * - length : 例`2px`
     * @param string $style 边框的样式, 边框样式可能的值:
     * - none : 无边框
     ...
     * - inset : 3D inset 边框
     * - outset : 3D outset 边框
     * @param string $color 边框的颜色, 例`#ff0000`
     * @return string
     */
     ...
     * @return string
     */
    public function border_radius8($x_top_left, $x_top_right, $x_bottom_right, $x_bottom_left, $y_top_left, $y_top_right, 
     ...
     * 表格单元格 - 间距大小
     *
     * @param string $length1 水平间距, 例`5px`
     * @param string $length2 垂直间距, 可选, 未设置时与水平间距相同.
     * @return string
     */
