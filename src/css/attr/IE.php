...
class IE extends CssAttr
{
    ...
    {
        return self::Visual_Filters . "Gradient('{$enabled}', '{$GradientType}', '{$StartColorStr}', '{$EndColorStr}')" .
             self::end;
    }
    ...
    {
        return self::Visual_Filters . "Alpha('{$enabled}', '{$GradientType}', '{$StartColorStr}', '{$EndColorStr}')" .
             self::end;
    }
