...
class Layout extends CssAttr
{
     ...
     *
     * @param string $content_border_box 可选参数:
     ...
     * 设置浮动
     *
     * @param string $left_right_none 浮动方向
     * @return string
     */
     ...
     * ~~~
     *
     * @param float $value 完全透明0.0 ~ 1.0不透明， 0可以不写`.5`
     * @return $this
     */
